...
const LoginEmpresaForm = ({ onLoginEmpresa }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Realiza la solicitud de autenticación al backend usando axios
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border ${!email ? "border-red-100" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 transition-all duration-200 ease-in-out`}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border ${!password ? "border-red-100" : "border-gray-300"} rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 transition-all duration-200 ease-in-out`}
          />
        </div>
