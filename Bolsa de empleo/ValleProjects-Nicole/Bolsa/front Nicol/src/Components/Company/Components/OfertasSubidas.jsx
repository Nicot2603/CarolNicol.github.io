...
const OfertasSubidas = () => {
  ...
  return (
    <div className="max-w-full md:max-w-5xl mx-auto p-4 md:p-6 bg-white rounded-xl shadow-xl mt-12">
      <h2 className="text-2xl md:text-3xl font-extrabold text-center mb-6 text-gray-900">
        Ofertas Subidas
      </h2>
      <div className="space-y-4 md:space-y-6">
        {offers.map((offer) => (
          <div
            key={offer.id}
            className="p-3 md:p-4 border border-gray-300 rounded-lg shadow-lg transition-transform transform hover:scale-105 bg-gray-50 dark:bg-gray-800"
          >
      ...
      {selectedOffer && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-bold mb-4 text-gray-900">Actualizar Oferta</h2>
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              ...
              <div>
                <label className="block text-sm font-semibold mb-1 text-gray-900">Descripción</label>
                <textarea
                  name="description"
              ...
              <div>
                <label className="block text-sm font-semibold mb-1 text-gray-900">Salario</label>
                <input
                  type="text"
                  name="salary"
              ...
              <div>
                <label className="block text-sm font-semibold mb-1 text-gray-900">Ubicación</label>
                <input
                  type="text"
                  name="location"
