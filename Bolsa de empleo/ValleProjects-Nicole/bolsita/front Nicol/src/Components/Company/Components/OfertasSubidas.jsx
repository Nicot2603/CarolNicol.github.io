      ...
      <div className="space-y-4 md:space-y-6">
        {offers.map((offer) => (
          <div
            ...
            style={{
              overflowWrap: "break-word", // Permite que las palabras largas se ajusten
              wordBreak: "break-word", // Compatibilidad con navegadores más antiguos
            }}
          >
            ...
            <p
              className="text-sm md:text-base text-gray-700 dark:text-gray-300 mb-2"
              style={{
                overflowWrap: "break-word", // Ajusta el texto en descripciones largas
